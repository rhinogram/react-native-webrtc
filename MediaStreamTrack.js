...
class MediaStreamTrack extends EventTarget(MEDIA_STREAM_TRACK_EVENTS) {
  ...
  set enabled(enabled: boolean): void {
    ...
    VWebRTCModule.mediaStreamTrackSetEnabled(this.id, !this._enabled);
    this._enabled = !this._enabled;
    this.muted = !this._enabled;
  }

  stop() {
    VWebRTCModule.mediaStreamTrackSetEnabled(this.id, false);
  ...
  _switchCamera() {
    ...
    VWebRTCModule.mediaStreamTrackSwitchCamera(this.id);
  }
  ...
  release() {
    VWebRTCModule.mediaStreamTrackRelease(this.id);
  }
}
