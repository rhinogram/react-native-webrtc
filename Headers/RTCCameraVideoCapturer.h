/*
 *  Copyright 2017 The VWebRTC project authors. All Rights Reserved.
 *
...
// in `format` is supported by the VWebRTC pipeline, the same pixel format will be used for the
