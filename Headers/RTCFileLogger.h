/*
 *  Copyright 2015 The VWebRTC project authors. All Rights Reserved.
 *
...
// This class intercepts VWebRTC logs and saves them to a file. The file size
...
// Starts writing VWebRTC logs to disk if not already started. Overwrites any
// existing file(s).
- (void)start;

// Stops writing VWebRTC logs to disk. This method is also called on dealloc.
- (void)stop;
