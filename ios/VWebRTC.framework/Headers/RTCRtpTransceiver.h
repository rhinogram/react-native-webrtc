/*
 *  Copyright 2018 The VWebRTC project authors. All Rights Reserved.
 *
 ...
 *  VWebRTC specification. A transceiver represents a combination of an RTCRtpSender
 ...
 *
 *  VWebRTC specification for RTCRtpTransceiver, the JavaScript analog:
