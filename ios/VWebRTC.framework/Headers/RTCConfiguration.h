 ...
 *  VWebRTC 1.0 specification requires UnifiedPlan semantics. The
 ...
 *  interoperable with legacy VWebRTC implementations or use legacy APIs,
 *  specify PlanB.
 *
 ...
 * frame encryption for native VWebRTC. Setting this will overwrite any
