...
/**
 * Reference to the main VWebRTC RN module.
 */
@property (nonatomic, weak) VWebRTCModule *module;
...
- (UIView *)view {
  ...
  v.module = [self.bridge moduleForName:@"VWebRTCModule"];
  v.clipsToBounds = YES;
  return v;
}
...
RCT_CUSTOM_VIEW_PROPERTY(streamURL, NSString *, RTCVideoView) {
    ...
    VWebRTCModule *module = view.module;
